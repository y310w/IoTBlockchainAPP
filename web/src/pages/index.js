    ...
    <Layout>
      <Container>
        ...
        <p>
          ...
          comunciación establecido entre nodos y validación de nuevos bloques.
        </p>
      </Container>
      ...
      <Container className="text-container">
        ...
        <p>
          De forma introductoria, la aplicación consiste en dos partes pricipalmente, por un lado 
          tenemos los dispositivos que pueden ser tanto sensores, como actuadores. Y por el otro, 
          los enlaces, que viene a representar la relación que hay entre un sensor y un actuador.
        </p>
      </Container>
      ...
      <Container className="text-container">
        ...
        <p>
          ...
          la dirección IP y un valor numerico. Este último indicará los distintos valores que va 
      ...
      <Container className="text-container">
        ...
        <p>
          ...
          Dicha condición va estar formado por una variable "value", acompañado de un operador de 
          comparación y un valor númerico. Ahora aparece en escena, el valor detectado por el sensor
          mencionado anteriormente.  
        </p>

        <p>
          Un enlace va estar condicionado por el cumplimiento de la condición establecida. Por defecto,
          el enlace creado va estar habilitado. Cuando un sensor recibe un valor, se comprobará cada 
